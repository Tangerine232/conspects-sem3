...
\lemma{
В определении дифференцируемости $(*)$ можно заменить на \[ \alpha=\sum_{k=1}^d\varepsilon_k(\Delta x)\Delta x_k, \qquad (**) \] где $\lim_{\Delta x\to\mathbb 0}\varepsilon_k(\Delta x)=0$.
}
